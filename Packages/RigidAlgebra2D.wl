...
TranswedgeProduct[x_,y_,1]:=Sum[Module[{c},c=VectorList[[i]];WedgeProduct[AntiwedgeProduct[Comp[c],x],AntiwedgeProduct[y,BulkDual[c]]]],{i,1,3}]


TranswedgeProduct[x_,y_,2]:=Sum[Module[{c},c=BivectorList[[i]];WedgeProduct[AntiwedgeProduct[Comp[c],x],AntiwedgeProduct[y,BulkDual[c]]]],{i,1,3}]


TranswedgeProduct[x_,y_,3]:=0
